...
#define MYTUNINGCONSTANT  34.36051818117860 // Replace with your calculated TUNING CONSTANT. See article
...
static char *bandWarnings[]     = {"Ext", "Tec", "Gen"}; //Altered in V1.0 of voltmeter implementation
static int whichLicense;
static char *incrementStrings[] = {
  "10", "20", "100", ".5", "1", "2.5", "5", "10", "100"};     // These two allign
static  long incrementTable[]   = { 
  10,   20,   100,   500, 1000, 2500, 5000, 10000, 100000};
static  long memory[]           = {
  VFOLOWERFREQUENCYLIMIT, VFOUPPERFREQUENCYLIMIT};
